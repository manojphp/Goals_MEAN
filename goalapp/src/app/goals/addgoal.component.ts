...
@Component({
  ...
  template: ` <form [formGroup]="form" (ngSubmit)="submit()" class="form">
    ...
    />
    <input type="date" formControlName="deadline" class="input is-normal m-2" pattern="\d{4}-\d{2}-\d{2}" />
    <textarea
...
export class AddgoalComponent implements OnInit {
  ...
  form:any;
  constructor(private goalService: GoalsService, private fb: FormBuilder,private router:Router,private datePipe: DatePipe) {
